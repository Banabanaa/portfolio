      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Projects</h1>
              <p class="mb-0">These projects are a mix of learning moments, academic requirements, passion projects, and experiments. 
                Some were built late at night out of curiosity, and others with a team for brewing something bigger. Below are a few I’ve worked on:
              </p>
            </div>
          </div>
        </div>
    ...
    <section id="gallery" class="gallery section">
      ...
      <div class="container-fluid" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="gallery-item h-100">
              <img src="assets/img/projects/cvsu.png" class="img-fluid" alt="">
              <div class="gallery-links d-flex align-items-center justify-content-center">
                <a href="assets/img/projects/cvsu.png" 
                title="CvSU Website" data-description="A simple website where it showcases the mission, vision, courses offered, and organizations of the school." 
                class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                <a href="cvsuwebsite.php" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="gallery-item h-100">
              <img src="assets/img/projects/lebug1.png" class="img-fluid" alt="">
              <div class="gallery-links d-flex align-items-center justify-content-center">
                <a href="assets/img/projects/lebug1.png" 
                title="LE BUG" data-description="A simple portfolio website designed for a small IT company to effectively showcase its expertise and services." 
                class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                <a href="lebug.php" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="gallery-item h-100">
              ...
              <div class="gallery-links d-flex align-items-center justify-content-center">
                <a href="assets/img/projects/emes.png" 
                title="EMES LIT Galing" data-description="The system was developed to create an effective educational website for Grade 6 students at Ezra Marie Elementary School." 
                class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                <a href="emes.php" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="gallery-item h-100">
              <img src="assets/img/projects/pos.png" class="img-fluid" alt="">
              <div class="gallery-links d-flex align-items-center justify-content-center">
                <a href="assets/img/projects/pos.png" 
                title="POS System" data-description="A user-friendly POS application for the owners of Likhang Kamay to easily access their inventory and sales tracking." 
                class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                <a href="POSsystem.php" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div>
          </div>
